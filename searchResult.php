			    ...
			    <div id="page_num" style="text-align: center;">
			    	<?php
				    	if ($page <= 1){
				    		...
				    		echo "<a href='searchResult.php?category=$category&search=$search&page=1'>처음</a>";
				    	}
				    	...
				    	if ($page <= 1){
				    		...
				    		$pre = $page - 1;
				    		echo "<a href='searchResult.php?category=$category&search=$search&page=$pre'>◀ 이전 </a>";
				    	}
				    	...
				    	for($i = $block_start; $i <= $block_end; $i++){
				    		if($page == $i){
				    			...
				    			echo "<a href='searchResult.php?category=$category&search=$search&page=$i'> $i </a>";
				    		}
				    	}
				    	...
				    	if($page >= $total_page){
				    		...
				    		$next = $page + 1;
				    		echo "<a href='searchResult.php?category=$category&search=$search&page=$next'> 다음 ▶</a>";
				    	}
					   	
				    	if($page >= $total_page){
				    		// 빈 값
				    	} else {
				    		echo "<a href='searchResult.php?category=$category&search=$search&page=$total_page'>마지막</a>";
				    	}
					?>
				</div>
				<br><br><br>
